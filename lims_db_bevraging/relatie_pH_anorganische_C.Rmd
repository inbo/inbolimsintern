...
In het analytisch laboratorium hebben we een afspraak met de onderzoekers om geen anorganische koolstof niet te meten indien pH-waarde kleiner is dan 6.5.
...
Daarnaast kan de verhouding vast:vloeibaar varieren van 1/5 tem 1/20.
...
Dit om te vermijden dat waarden worden meegenomen waarbij geen meting van anorganische koolstof (TIC of CaCO3) is uitgevoerd, maar waarbij een nulwaarde is geïntroduceerd louter op basis van de pH.
